...
ALTER TABLE `PRICE_POLICY_HISTORY` ADD CONSTRAINT `FK_PRICE_POLICY_TO_PRICE_POLICY_HISTORY_1` FOREIGN KEY (
	`PRICE_POLICY_ID`
)
...
ALTER TABLE `PRICE_POLICY_HISTORY` ADD CONSTRAINT `FK_ADMIN_TO_PRICE_POLICY_HISTORY_1` FOREIGN KEY (
	`ADMIN_ID`
)
REFERENCES `ADMIN` (
	`ADMIN_ID`
