...
<%--                </div>--%>
<%--                <div class="dates">--%>
<%--&lt;%&ndash;                    <fmt:formatDate value="${item.desiredCheckInAt}" pattern="yyyy.MM.dd (E)"/>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    –&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <fmt:formatDate value="${item.desiredCheckOutAt}" pattern="yyyy.MM.dd (E)"/>&ndash;%&gt;--%>
<%--                </div>--%>
<%--                <div class="details">--%>
